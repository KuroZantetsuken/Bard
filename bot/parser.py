...
# Initialize logger for the message parser module.
...
class MessageParser:
    ...
    async def _extract_discord_context(self, message: Message) -> DiscordContext:
        ...
        if isinstance(channel, discord.TextChannel):
            ...
            # In DMs, only the user and the bot are "in the channel".
    ...
    async def parse(self, message: Message) -> ParsedMessageContext:
        ...
        # Extract content and attachments from replied message, if any.
        if message.reference and message.reference.message_id:
            try:
                ...
                pass  # Replied message not found, continue without it.

        cleaned_content = message.content
        # The cleaned_reply_chain_text is initialized directly from reply_chain_text
        # and further cleaned by _clean_content_from_urls.
        ...
        # Process URLs found in message content.
        ...
        # Clean message content by removing processed URLs.
        ...
        # Combine all attachments (current message and replied message).
