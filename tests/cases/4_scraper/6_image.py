...
class ImageScraperTest(BardTestCase):
    async def test_image_search_scraping(self):
        ...
        self.assertTrue("scheduled" in content_lower or "created" in content_lower, 
        ...
        self.assertTrue(image_attr is not None, f"Event should have a banner image. Attributes found: {dir(event)}")
