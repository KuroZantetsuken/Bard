...
# Initialize logger for the tool registry module.
...
class ToolRegistry:
    ...
    def _discover_and_load_tools(self):
        ...
        # Create a shared ToolContext instance to be passed to all tools.
                ...
                try:
                    ...
                    for attribute_name in dir(module):
                        ...
                        if (
                            ...
                            try:
                                # Instantiate the tool and pass the shared ToolContext.
                                ...
                                # Map each function declared by the tool to its tool class name.
                                for (
                                    func_decl
