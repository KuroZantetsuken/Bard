...
async def main():
    ...
    if not os.path.exists(extensions_path):
        logger.error(f"Extensions path not found at '{extensions_path}'. Please ensure it exists.")
        return
    extension_dirs = [
    ...
    browser_args = [f"--disable-extensions-except={disable_extensions_arg}"] + load_extension_args
    ...
    logger.info(f"The user data directory at '{persistent_context_path}' is now configured with your custom settings.")
